...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        'content_creation': '20/hour',  # Locations, reviews, comments: 20 per hour
        'vote': '60/hour',  # Upvotes/downvotes: 60 per hour (1 per minute)
        'report': '10/hour',  # Content reports: 10 per hour
    },
}
