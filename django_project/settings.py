...
# Use R2 for media storage only (static files still use Whitenoise)
...
# Media URL - automatically generated by django-storages using AWS_S3_CUSTOM_DOMAIN
# No need to set manually when using S3-compatible storage

# Keep local MEDIA_ROOT for development/fallback
