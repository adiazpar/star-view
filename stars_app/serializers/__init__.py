...
# cleaner imports throughout the application (e.g., `from stars_app.serializers import                  #
# ReviewSerializer` instead of `from stars_app.serializers.serializer_review import ReviewSerializer`). #
#                                                                                                       #
